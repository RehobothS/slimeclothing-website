   ...
   <form action="" method="post">
      ...
      <div class="flex">
         <div class="inputBox">
            ...
            <input type="text" name="name" required placeholder="Rehoboth Salako">
         </div>
         <div class="inputBox">
            <span>Enter YourNumber:</span>
            <input type="number" name="number" required placeholder="0896760125">
         </div>
         <div class="inputBox">
            <span>Your Email:</span>
            <input type="email" name="email" required placeholder="10604590@mydbs.ie">
         </div>
         <div class="inputBox">
         ...
         <div class="inputBox">
            <span>Pin Code:</span>
            <input type="number" min="0" name="pin_code" required placeholder="W91 P026">
         </div>
      </div>
